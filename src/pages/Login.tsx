...
const Login = () => {
  ...
  const inputClassName =
    "w-full rounded-xl border border-slate-200 bg-slate-50/70 py-3.5 pl-11 pr-4 text-base text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-green-500 focus:bg-white focus:ring-4 focus:ring-green-100/70 disabled:cursor-not-allowed disabled:opacity-70 sm:text-sm";

  const passwordInputClassName =
    "w-full rounded-xl border border-slate-200 bg-slate-50/70 py-3.5 pl-11 pr-14 text-base text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-green-500 focus:bg-white focus:ring-4 focus:ring-green-100/70 disabled:cursor-not-allowed disabled:opacity-70 sm:text-sm";
          ...
          <div className="relative z-10">
            ...
            <div className="mt-20 max-w-md">
              ...
              <p className="mt-6 max-w-sm text-base leading-7 text-green-50/90">
                ...
                cart, saved items, account
                details and future orders.
              </p>
            </div>
          </div>
            ...
            >
              ...
              <div>
                <div className="mb-1.5 flex items-center justify-between gap-3 sm:mb-2">
                  ...
                  <Link
                    to="/forgot-password"
                    className="shrink-0 text-xs font-bold text-green-600 transition hover:text-green-700"
                  >
                    Forgot password?
                  </Link>
                </div>
